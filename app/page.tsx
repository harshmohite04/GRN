...
export default function Home() {
  return (
    <div style={{ minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      {/* FOOTER */}
      <footer style={{ borderTop: "1px solid #e2e8f0", padding: "18px 20px", textAlign: "center", color: "var(--text-muted)", fontSize: "0.78rem", background: "#fff" }}>
        © 2025 GRN Automation. All rights reserved.
      </footer>
    </div>
  );
}
